...
Exec Dbms_Fga.Drop_Policy (Object_Schema => 'DBSEC', Object_Name => 'CUSTOMER',Policy_Name => 'AUDIT_MY_POLICY_1_SELECT');

Exec Dbms_Fga.Add_Policy (OBJECT_Schema => 'DBSEC',-
			  Object_Name => 'CUSTOMER',-
			POLICY_NAME => 'AUDIT_MY_POLICY_1_SELECT', -
...
EXEC Dbms_Fga.Drop_Policy (Object_Schema => 'DBSEC',	Object_Name => 'CUSTOMER',Policy_Name => 'AUDIT_MY_POLICY_2_CREDIT');

Exec Dbms_Fga.Add_Policy (OBJECT_Schema => 'DBSEC',-
			  Object_Name => 'CUSTOMER',-
			POLICY_NAME => 'AUDIT_MY_POLICY_2_CREDIT', -
...
EXEC Dbms_Fga.Drop_Policy (Object_Schema => 'DBSEC',	Object_Name => 'CUSTOMER',Policy_Name =>'AUDIT_MY_POLICY_3_DELETE');
Exec Dbms_Fga.Add_Policy (OBJECT_Schema => 'DBSEC',-
			  Object_Name => 'CUSTOMER',-
			POLICY_NAME => 'AUDIT_MY_POLICY_3_DELETE', -
			AUDIT_CONDITION => Null,-
			AUDIT_COLUMN => Null, -
			HANDLER_SCHEMA => Null, -
			HANDLER_MODULE => Null,-
...
select DB_USER, SESSION_ID, Object_Name, OS_USER, timestamp 
