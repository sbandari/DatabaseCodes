...
drop function DBSEC_ROW_MYOWNER_FUNCTION;

Create OR Replace function DBSEC_ROW_MYOWNER_FUNCTION(p_schema in varchar2, p_object in varchar2 )
RETURN varchar2
as
BEGIN
if( user= 'DBSEC') then
...
POLICY_FUNCTION => 'DBSEC_ROW_MYOWNER_FUNCTION',
